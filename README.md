...
Management Tier: A workstation interface utilizing a web-based dashboard to issue commands.

Gateway Tier (Sentinel): A Raspberry Pi 4 running a Dockerized Flask application. This layer handles authentication, logging, and protocol translation.

Edge Tier: ESP32-WROVER-DEV microcontrollers connected via USB/Serial. These nodes execute physical movement and sensor data collection.
...
Bash
git clone https://github.com/ctarique/iot-lab-remote-gateway.git
